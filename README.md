...
If the notebook cannot be properly displayed, please go to https://nbviewer.jupyter.org/github/bcjuang/Black_Friday_Sale_Prediction/blob/master/Black_Friday_sales_dataset_final.ipynb
<br><br>
### Problem statement
